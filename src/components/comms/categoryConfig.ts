import { CommCategory, ChaseSubtype, ConversationSubtype } from '@/types/communication';
...
export const CATEGORIES: CategoryDef[] = [
  ...
  { value: 'collexis-handover', label: 'Collexis Handover', color: 'bg-teal-100 text-teal-700', dotColor: 'bg-teal-400' },
